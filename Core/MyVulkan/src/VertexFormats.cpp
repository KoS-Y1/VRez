...
const VkPipelineVertexInputStateCreateInfo *VertexP::GetVertexInputStateCreateInfo() {
    static const std::vector<VkVertexInputBindingDescription> bindingDescriptions{
        {.binding = 0, .stride = sizeof(VertexP), .inputRate = VK_VERTEX_INPUT_RATE_VERTEX}
    };

    static const std::vector<VkVertexInputAttributeDescription> attributeDescriptions{
        {.location = 0, .binding = 0, .format = VK_FORMAT_R32G32B32_SFLOAT, .offset = offsetof(VertexP, position)}
    };
...
const VkPipelineVertexInputStateCreateInfo *VertexPNT::GetVertexInputStateCreateInfo() {
    static const std::vector<VkVertexInputBindingDescription> bindingDescriptions{
        {.binding = 0, .stride = sizeof(VertexPNT), .inputRate = VK_VERTEX_INPUT_RATE_VERTEX}
    };

    static const std::vector<VkVertexInputAttributeDescription> attributeDescriptions{
        {.location = 0, .binding = 0, .format = VK_FORMAT_R32G32B32_SFLOAT, .offset = offsetof(VertexPNT, position) },
        {.location = 1, .binding = 0, .format = VK_FORMAT_R32G32B32_SFLOAT, .offset = offsetof(VertexPNT, normal)   },
        {.location = 2, .binding = 0, .format = VK_FORMAT_R32G32_SFLOAT,    .offset = offsetof(VertexPNT, texCoords)}
    };
...
const VkPipelineVertexInputStateCreateInfo *VertexPNTT::GetVertexInputStateCreateInfo() {
    static const std::vector<VkVertexInputBindingDescription> bindingDescriptions{
        {.binding = 0, .stride = sizeof(VertexPNTT), .inputRate = VK_VERTEX_INPUT_RATE_VERTEX}
    };

    static const std::vector<VkVertexInputAttributeDescription> attributeDescriptions{
        {.location = 0, .binding = 0, .format = VK_FORMAT_R32G32B32_SFLOAT, .offset = offsetof(VertexPNTT, position) },
        {.location = 1, .binding = 0, .format = VK_FORMAT_R32G32B32_SFLOAT, .offset = offsetof(VertexPNTT, normal)   },
        {
        ...
        {.location = 3, .binding = 0, .format = VK_FORMAT_R32G32_SFLOAT,    .offset = offsetof(VertexPNTT, texCoords)}
    };
